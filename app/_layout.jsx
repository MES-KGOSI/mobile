      ...
      {navItems.map(({ label, href }, i) => (
        <Link href={href} key={label} asChild>
          ...
          >
            ...
            />
            <Text style={[styles.navLinkText, activeIndex === i && styles.navLinkTextActive]}>
              {label}
            </Text>
          </TouchableOpacity>
        </Link>
    ...
    <View style={styles.outerContainer}>
      <View style={styles.container}>
        <View style={styles.mobileNavBar}>
          <TouchableOpacity style={styles.logoTouchable} onPress={() => router.push("/")} accessibilityLabel="Go to Home">
            <ResponsiveImage source={logoBlack} widthRatio={0.45} aspectRatio={3} />
          </TouchableOpacity>

          <TouchableOpacity style={[styles.searchButtonMobile, { left: searchButtonLeft }]} onPress={toggleSearch} accessibilityLabel="Toggle search">
            <Ionicons name="search" size={28} color="black" />
          </TouchableOpacity>

          <TouchableOpacity onPress={toggleMenu} style={styles.hamburgerButton} accessibilityLabel="Menu toggle">
        ...
        {searchOpen && (
          <View style={styles.searchBoxMobile}>
            <TextInput placeholder="Search for courses" style={styles.searchInput} autoFocus />
          </View>
        )}
