...
import firstAidImg from "../assets/images/childminding.png";
import sewingImg from "../assets/images/cooking.png";
import landscapingImg from "../assets/images/garden.png";

export default function SixWeeksInfo() {
        ...
        {courses.map((course) => (
          <View key={course.id} style={styles.card}>
            ...
            <View style={styles.imageWrapper}>
              ...
              <Text style={styles.priceText}>R 750</Text>
            </View>
          </View>
        ))}
      </ScrollView>
